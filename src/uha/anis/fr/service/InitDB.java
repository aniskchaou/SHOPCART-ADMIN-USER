...
public class InitDB {
	...
	void insertProducts() {
		CategoryDAO categoryDAO = new CategoryDAOImpl();
		Product product = new Product(1, "BISSELL Cleanview Swivel Pet Upright ",
				"save pets; Bissell donates up to 10 dollars to the Bissell ", "1.jpg", 99, 10, 12,
				categoryDAO.getCategoryById(1));
		Product product2 = new Product(2, "Philips Sonicare HX9023/65 Genuine C2 , 3 Pack, White",
				"SUPERIOR CLEAN: Clinically proven to remove up to 7x more plaque ", "2.jpg", 24, 9, 6,
				categoryDAO.getCategoryById(2));
		Product product3 = new Product(3, "USB Type C Cable, Anker [2-Pack, 6 ft] ", "", "3.jpg", 14, 2, 11,
				categoryDAO.getCategoryById(3));
		Product product4 = new Product(4, "Apple AirPods with Wired Charging Case",
				"Automatically on, automatically connected", "4.jpg", 150, 3, 3, categoryDAO.getCategoryById(4));
		Product product5 = new Product(5, "Samsung SSD 860 EVO 1TB 2.5 Inch SATA III ",
				"Innovative V-Nand Technology: Powered by Samsung V-Nand Technology", "5i.jpg", 139, 11, 2,
